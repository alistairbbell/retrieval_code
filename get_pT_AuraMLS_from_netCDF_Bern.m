function ptz=get_pT_AuraMLS_from_netCDF_Bern(time1, time2, lat, lon,version)
...
% 2022-08-05: Conversion of file to Netcdf input 

datetime_ecmwf = datetime(msm.min_time(1)*(60*60*24),'ConvertFrom','epochtime');
...
disp(datestring_ecmwf)
disp(datestring_ecmwf_plusone)
